<%@ Page AutoEventWireup="true" Inherits="SitecoreExtension.MediaUploadBatch.Utilities.CustomUploadPage" Language="C#" %>
    ...
    <input id="ErrorText" runat="server" type="hidden" value="" />
            ...
            <td valign="top" width="100%">
              <div class="scFormDialogHeader">
                <div class="DialogHeader">
                  <sc:Literal runat="server" Text="Media Batch Upload"/>
                </div>
        ...
        <div id="OptionTableWrapper">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td>
                  <input id="Unpack" name="Unpack" type="checkbox" value="1" checked disabled/><label for="Unpack"><sc:Literal runat="server" Text="Unpack ZIP archives"></sc:Literal></label>
                </td>
                <td>
